package com.core.filterframe.taglayout;
...
import com.core.filterframe.taglayout.utils.MeasureUtils;
...
public class TagEditView extends AppCompatTextView {
    ...
    // 显示外形
    private int mTagShape = TagView.SHAPE_ROUND_RECT;
    // 边框角半径
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (parent instanceof TagLayout) {
            ...
            if (fitTagNum != TagView.INVALID_VALUE) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        } else if (mTagShape == TagView.SHAPE_RECT) {
            radius = 0;
        }
